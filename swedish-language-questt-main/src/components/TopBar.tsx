...
export const TopBar = ({
  backgroundColor = "bg-[#fcd5d4]",
  borderColor = "border-[#fcd5d4]",
}: {
  ...
  return (
    <header className="fixed z-20 h-[58px] w-full">
      <div
        className={`relative flex h-full w-full items-center justify-between border-b-2 px-[10px] transition duration-500 sm:hidden border-white bg-white`}
      >
        <button
        ...
        >
          {streak > 0 ? <Image src={firr} width="30" height="20" alt={""} /> : <EmptyFireTopBarSvg />}{" "}
