...
export const LoginScreen = ({
  ...
  return (
    <article
      className={[
        "fixed inset-0 z-30 flex flex-col bg-gray-400 p-7 transition duration-300",
    ...
    >
      <header className="flex flex-row-reverse justify-between sm:flex-row">
        ...
        <button
          className="hidden rounded-2xl border-2 border-b-4 border-gray-200 px-4 py-3 text-sm font-bold uppercase text-white-300 transition hover:bg-gray-200 hover:brightness-90 sm:block"
          onClick={() =>
      ...
      <div className="flex grow items-center justify-center">
        <div className="flex w-full flex-col gap-5 sm:w-96">
          ...
          <button
            className="rounded-2xl border-b-4 border-pink-400 bg-pink-400 py-3 font-bold uppercase text-white transition hover:brightness-110"
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold uppercase text-white">or</span>
            <div className="h-[2px] grow bg-gray-300"></div>
          </div>
