...
import journalist from 'public/bee.gif'
import mother from 'public/squirrel.gif'
import croupie from 'public/bear.gif'
import fathe from 'public/duck.gif'
import grandmothe from 'public/turkey.gif'
import studen from 'public/dandelion.gif'
import judg from 'public/sunflower.gif'
import mine from 'public/monster.gif'
import policema from 'public/ferris-wheel.gif'
import showma from 'public/horse.gif'
...
const lessonProblem2 = {
  ...
  question: "What is the English translation for 'Tack'?",
  answerTiles: ["Yes", "No", "Please", "Thankyou"],
  correctAnswer: [3],
} as const;

const lessonProblem3 = {
  type: "WRITE_IN_ENGLIS",
  question: "Identify the English translation for 'Förlåt'",
  answerTiles: ["Thankyou","I don't understand","Excuse me", " sorry"],
  correctAnswer: [3],
} as const;

const lessonProblem111 = {
  type: "WRITE_IN_ENGLIS1",
  question: "How would you say 'Ursäkta mig' in English?",
  answerTiles: ["Hello!","Goodbye","Excuse me", "Thank you"],
  correctAnswer: [2],
} as const;

const lessonProblem222 = {
  type: "WRITE_IN_ENGLIS2",
  question: "What is the English translation for 'Hej!'?",
  answerTiles: ["Hello!","Goodbye","Thank you", "Excuse me"],
  correctAnswer: [0],
} as const;

const lessonProblem333 = {
  type: "WRITE_IN_ENGLIS3",
  question: "Identify the English translation for 'Nej'.",
  answerTiles: ["No","Yes","Please", "I don't understand"],
  correctAnswer: [0],
} as const;

const lessonProblem444 = {
  type: "WRITE_IN_ENGLIS4",
  question: "How would you say 'Hur mår du?' in English?",
  answerTiles: ["I don't understand","Please","Thank you", "How are you"],
  correctAnswer: [3],
} as const;

const lessonProblem555 = {
  type: "WRITE_IN_ENGLIS5",
  question: "What is the English translation for 'Adjö'?",
  answerTiles: ["Please","sorry","Goodbye", "How are you"],
  correctAnswer: [2],
} as const;
...
const lessonProblem666 = {
  ...
  question: "Identify the English translation for 'Ja'.",
  answerTiles: ["Thankyou","yes","No", "Excuse me"],
  correctAnswer: [1],
} as const;

const lessonProblem777 = {
  type: "WRITE_IN_ENGLIS7",
  question: "How would you say 'Snälla' in English?",
  answerTiles: ["sorry","Thank you","How are you", "Please"],
  correctAnswer: [3],
} as const;

const lessonProblem999 = {
  type: "WRITE_IN_ENGLIS9",
  question: "What is the English translation for 'Jag förstår inte'?",
  answerTiles: ["Thank you","I don't understand","Yes", "No"],
  correctAnswer: [1],
} as const;
