          ...
          return (
            <Fragment key={i}>
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (
                              ...
                              void router.push(
                                `/lesson${unit.unitNumber}${tile.id}?fast-forward=${unit.unitNumber}`
                              );
                              return;
                            }
                            setSelectedTile(i);
              ...
              <TileTooltip
                ...
                unitNumber={unit.unitNumber}
                tilesLength={unit.tiles.length}
                route={`lesson${unit.unitNumber}${tile.id}`}
                description={(() => {
                  switch (tile.type) {
                    case "book":
                    case "dumbbell":
