...
const lessonProblem2 = {
  ...
  question: "What is the English translation for 'Vatten'?",
  answerTiles: ["Coffee", "Meat", "Bread", "Water"],
  correctAnswer: [3],
} as const;

const lessonProblem3 = {
  type: "WRITE_IN_ENGLIS",
  question: "Identify the English translation for 'Ost'.",
  answerTiles: ["Juice","Cheese","Pizza","Ice cream"],
  correctAnswer: [1],
} as const;

const lessonProblem111 = {
  type: "WRITE_IN_ENGLIS1",
  question: "How would you say 'Sallad' in English?",
  answerTiles: ["Fish","Salad","Meat", "Bread"],
  correctAnswer: [1],
} as const;

const lessonProblem222 = {
  type: "WRITE_IN_ENGLIS2",
  question: "What is the English translation for 'Glass'?",
  answerTiles: ["Juice","Salad","Fish", "Ice cream"],
  correctAnswer: [3],
} as const;

const lessonProblem333 = {
  type: "WRITE_IN_ENGLIS3",
  question: "Identify the English translation for 'Kött'.",
  answerTiles: ["Meat","Salad","Left", "Juice"],
  correctAnswer: [0],
} as const;

const lessonProblem444 = {
  type: "WRITE_IN_ENGLIS4",
  question: "How would you say 'Fisk' in English?",
  answerTiles: ["Coffee","Meat","Fish", "Water"],
  correctAnswer: [2],
} as const;

const lessonProblem555 = {
  type: "WRITE_IN_ENGLIS5",
  question: "What is the English translation for 'Kaffe'?",
  answerTiles: ["Juice","Meat","Coffee", "Bread"],
  correctAnswer: [2],
} as const;
...
const lessonProblem666 = {
  ...
  question: "Identify the English translation for 'Bröd'.",
  answerTiles: ["Bread","Fish","Coffee", "Ice cream"],
  correctAnswer: [0],
} as const;

const lessonProblem777 = {
  type: "WRITE_IN_ENGLIS7",
  question: "How would you say 'Juice' in English?",
  answerTiles: ["Meat","Juice","Ice cream","Salad"],
  correctAnswer: [1],
} as const;

const lessonProblem999 = {
  type: "WRITE_IN_ENGLIS9",
  question: "What is the English translation for 'Pizza'?",
  answerTiles: ["Fish","Salad","Pizza", "Water"],
  correctAnswer: [2],
} as const;
