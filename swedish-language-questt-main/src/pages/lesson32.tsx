...
const lessonProblem2 = {
  ...
  question: "What is the English translation for 'Taxi'?",
  answerTiles: ["Bus", "Hotel","Taxi","Left"],
  correctAnswer: [2],
} as const;

const lessonProblem3 = {
  type: "WRITE_IN_ENGLIS",
  question: "Identify the English translation for 'Rakt fram'.",
  answerTiles: ["Left","Taxi","Right","Straight ahead"],
  correctAnswer: [3],
} as const;

const lessonProblem111 = {
  type: "WRITE_IN_ENGLIS1",
  question: "How would you say 'Hotell' in English?",
  answerTiles: ["Hotel","Bus", "Left","Right"],
  correctAnswer: [0],
} as const;

const lessonProblem222 = {
  type: "WRITE_IN_ENGLIS2",
  question: "What is the English translation for 'Buss'?",
  answerTiles: ["Train station","Bus", "Airport","Hotel"],
  correctAnswer: [1],
} as const;

const lessonProblem333 = {
  type: "WRITE_IN_ENGLIS3",
  question: "Identify the English translation for 'Tågstation'.",
  answerTiles: ["Left","Hotel","Train station","Right"],
  correctAnswer: [2],
} as const;

const lessonProblem444 = {
  type: "WRITE_IN_ENGLIS4",
  question: "How would you say 'Flygplats' in English?",
  answerTiles: ["Taxi","Airport","Straight ahead","Bus"],
  correctAnswer: [1],
} as const;
...
const lessonProblem555 = {
  ...
  question: "What is the English translation for 'Vänster'?",
  answerTiles: ["Left","Taxi","Right", "Hotel"],
  correctAnswer: [0],
} as const;

const lessonProblem666 = {
  type: "WRITE_IN_ENGLIS6",
  question: "Identify the English translation for 'Höger'.",
  answerTiles: ["Left","Hotel","Right","Straight ahead"],
  correctAnswer: [2],
} as const;
...
const lessonProblem777 = {
  ...
  answerTiles: ["Excuse me","Left","Right","Straight ahead"],
  correctAnswer: [0],
} as const;

const lessonProblem999 = {
  type: "WRITE_IN_ENGLIS9",
  question: "What is the English translation for 'Biljett'?",
  answerTiles: ["Left","Right","Bus", "Ticket"],
  correctAnswer: [3],
} as const;
